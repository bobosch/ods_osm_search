...
class tx_odsosmsearch_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_odsosmsearch_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_odsosmsearch_pi1.php';	// Path to this script relative to the extension dir.
	var $extKey        = 'ods_osm_search';	// The extension key.
		...
		if($this->piVars['zip']){
			...
			if(is_array($addresses)){
				foreach($addresses as $address){
					$address['distance']=round($address['distance'],$this->conf['distance.']['round']);
